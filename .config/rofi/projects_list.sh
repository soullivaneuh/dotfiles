...
echo "Fetching git.sullivansenechal.com projects..."
LAB_CORE_HOST="https://git.sullivansenechal.com" LAB_CORE_TOKEN=${GITLAB_SULLI_TOKEN} lab project list --member --all \
  | sed -e 's#^#git.sullivansenechal.com/#' \
  >> ${1}
